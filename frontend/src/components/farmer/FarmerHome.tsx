...
import { WithdrawalCountdownCard } from '../dashboard/WithdrawalCountdownCard';
...
export const FarmerHome: React.FC<FarmerHomeProps> = ({ onNavigate, onOpenRegisterAnimal, stats }) => {
  ...
  return (
    <div className="space-y-8 sm:space-y-10 max-w-6xl mx-auto px-4 py-1 font-sans">
      ...
      {/* ========================================================================= */}
      {/* ⏳ ACTIVE ANTIMICROBIAL WITHDRAWAL EMBARGO COUNTDOWN (MRL SAFETY) */}
      {/* ========================================================================= */}
          ...
          withdrawals={[
            {
              ...
              animal_code: 'COW-102',
              product: 'milk',
              medicine_name: 'Oxytetracycline LA 20%',
              end_date: new Date(Date.now() + 2.5 * 86400000).toISOString(),
            },
          ]}
          onSelectAnimal={() => onNavigate('animals')}
        />
      )}

      {/* ========================================================================= */}
      {/* 📡 METEOROLOGICAL THI & SYNDROMIC HERD MORBIDITY INTELLIGENCE */}
      {/* ========================================================================= */}
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
          ...
          <Link href="/calendar">
            <Card
              variant="glass"
              hoverEffect
              className="cursor-pointer border-2 border-amber-500/30 hover:bg-amber-50/50 p-5 flex flex-col justify-between group text-center items-center space-y-2 h-full"
            >
              <span className="text-3xl">📅</span>
              <span className="text-sm font-black text-amber-900">Withdrawal Calendar</span>
            </Card>
          </Link>

          <Link href="/surveillance/map">
            <Card
              variant="glass"
              hoverEffect
              className="cursor-pointer border-2 border-red-500/30 hover:bg-red-50/50 p-5 flex flex-col justify-between group text-center items-center space-y-2 h-full"
            >
              <span className="text-3xl">🗺️</span>
              <span className="text-sm font-black text-red-700">Outbreak GIS Map</span>
            </Card>
          </Link>

          <Link href="/syndromic-report">
            <Card
              variant="glass"
              hoverEffect
              className="cursor-pointer border-2 border-red-500/30 hover:bg-red-50/50 p-5 flex flex-col justify-between group text-center items-center space-y-2 h-full"
            >
              <span className="text-3xl">🚨</span>
              <span className="text-sm font-black text-red-700">Syndromic Triage</span>
            </Card>
          </Link>
          ...
          <Link href="/medicines">
            <Card
              variant="glass"
              hoverEffect
              className="cursor-pointer border-2 border-sky-500/30 hover:bg-sky-50/50 p-5 flex flex-col justify-between group text-center items-center space-y-2 h-full"
            >
              <span className="text-3xl">💉</span>
              <span className="text-sm font-black text-sky-900">Medicines & MRLs</span>
            </Card>
          </Link>
          ...
          <Link href="/lab-results">
            <Card
              variant="glass"
              hoverEffect
              className="cursor-pointer border-2 border-purple-500/30 hover:bg-purple-50/50 p-5 flex flex-col justify-between group text-center items-center space-y-2 h-full"
            >
              <span className="text-3xl">🧪</span>
              <span className="text-sm font-black text-purple-900">Lab Diagnostic Tests</span>
            </Card>
          </Link>
          ...
          <Link href="/risk-assessment">
            <Card
              variant="glass"
              hoverEffect
              className="cursor-pointer border-2 border-indigo-500/30 hover:bg-indigo-50/50 p-5 flex flex-col justify-between group text-center items-center space-y-2 h-full"
            >
              <span className="text-3xl">🤖</span>
              <span className="text-sm font-black text-indigo-900">AI Risk Intelligence</span>
            </Card>
          </Link>
          ...
          <Link href="/reports">
            <Card
              variant="glass"
              hoverEffect
              className="cursor-pointer border-2 border-emerald-500/30 hover:bg-emerald-50/50 p-5 flex flex-col justify-between group text-center items-center space-y-2 h-full"
            >
              <span className="text-3xl">📋</span>
              <span className="text-sm font-black text-emerald-900">Official Reports</span>
            </Card>
          </Link>
