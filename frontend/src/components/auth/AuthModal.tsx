          ...
          <div className="space-y-8 relative z-10">
            ...
            <div className="space-y-2">
              <h2 className="text-2xl sm:text-3xl font-black text-white leading-tight">
                National Digital Livestock Portal
              </h2>
              <p className="text-xs sm:text-sm text-gray-300 font-medium leading-relaxed">
                Integrated Livestock Health Intelligence, AMR Surveillance & MRL Governance
              </p>
            </div>
              ...
              <div className="p-4 bg-white border-2 border-red-300 rounded-2xl shadow-lg space-y-3 animate-in fade-in">
                <div className="flex items-center justify-between text-xs font-black text-gray-800">
                  <span className="flex items-center gap-1.5">
                    ...
                    <span>Sign in with Google ({role.toUpperCase()}):</span>
                  </span>
                  <button
                    type="button"
                ...
                <button
                  ...
                  onClick={async () => {
                    try {
                      ...
                      setError(err.message || 'Google OAuth failed. You can use 1-Click login below.');
                      setLoading(false);
                    }
                  }}
                  className="w-full p-2.5 rounded-xl border-2 border-red-500 bg-red-50 hover:bg-red-100 text-red-900 font-black text-xs flex items-center justify-center gap-2 transition-colors cursor-pointer shadow-xs"
                >
                  <span className="text-base font-black text-red-600">G</span>
                  <span>Continue with Live Google OAuth</span>
                </button>

                <div className="flex items-center gap-2 text-[10px] text-gray-400 font-bold uppercase tracking-wider">
                  <div className="flex-1 h-px bg-gray-200" />
                  <span>or instant 1-click profile</span>
                  <div className="flex-1 h-px bg-gray-200" />
                </div>

                {/* Instant 1-Click Demo Google Profile */}
                <div className="space-y-2 text-xs font-bold">
                  <button
                    ...
                    className="w-full p-2.5 rounded-xl border border-gray-200 hover:bg-emerald-50 hover:border-emerald-300 text-left flex items-center gap-3 transition-colors cursor-pointer"
                  >
                    ...
                    <div className="flex-1">
                      <p className="text-gray-900 font-black flex items-center justify-between">
                        <span>{role === 'farmer' ? 'Ramesh Patel' : role === 'vet' ? 'Dr. Priya Sharma' : 'Sh. Rajesh Verma'}</span>
                        <span className="text-[10px] uppercase font-bold text-emerald-700 bg-emerald-100 px-1.5 py-0.5 rounded-md">Instant</span>
                      </p>
