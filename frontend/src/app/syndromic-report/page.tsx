...
import { SyndromicReportModal } from '../../components/syndromic/SyndromicReportModal';

export default function SyndromicReportPage() {
    ...
    <div className="min-h-screen flex flex-col bg-gray-50/50 font-sans">
      ...
      <div className="flex-1 flex">
        ...
        <main className="flex-1 p-4 sm:p-8 max-w-5xl mx-auto w-full pb-24 lg:pb-8">
          <SyndromicReportModal onClose={() => router.push('/')} />
        </main>
      </div>
